...
#define SFINAE_OP(ret, op)                                                   \
    decltype(doctest::detail::declval<L>() op doctest::detail::declval<R>(), \
             static_cast<ret>(0))
        ...
        if (!doctest::getContextOptions()->no_throw) {                       \
            ...
            try {                                                            \
                DOCTEST_CAST_TO_VOID(expr)                                   \
                     ...
                     typename doctest::detail::remove_reference<             \
...
bool ResultBuilder::log() {
    ...
    } else if (m_at & assertType::is_throws_as) {  //! OCLINT bitwise operator
                                                   //! in conditional
        m_failed = !m_threw_as;
