...
Term::Buttons Mouse::getButtons() { return m_buttons; }

Term::Buttons::Type Buttons::getType() { return m_type; }

Term::Buttons::Action Buttons::getAction() { return m_action; }

std::size_t Mouse::row() const { return m_rows; }

std::size_t Mouse::column() const { return m_columns; }
