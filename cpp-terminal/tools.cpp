...
inline uint8_t Term::utf8_decode_step(uint8_t state,
                                      uint8_t octet,
                                      uint32_t *cpp) {
...
inline std::string Term::utf32_to_utf8(const std::u32string &s) {
    std::string r{};
    for (char32_t i : s) {
...
int Term::convert_string_to_int(const char *string,
                                const char *format,
                                int *rows,
                                int *cols) {
#ifdef _WIN32
