...
{
  const constexpr int b1OOOOOOO{128};
  const constexpr int b11OOOOOO{192};
  const constexpr int b111OOOOO{224};
  const constexpr int b1111OOOO{240};
  const constexpr int b11111OOO{248};
