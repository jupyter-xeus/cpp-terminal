...
public:
  ...
  constexpr inline Key(const Key& key)            = default;
  constexpr inline Key& operator=(const Key& key) = default;

  //constexpr inline Key(const Value& v) : value(static_cast<std::int32_t>(v)){}
  //constexpr inline Key& operator=(const Value& v){this->value = static_cast<std::int32_t>(v); return *this;}

  explicit constexpr inline Key(char val) : value(static_cast<std::int32_t>(val)) {}
  constexpr inline Key& operator=(char val)
  {
    value = static_cast<std::int32_t>(val);
    return *this;
  }

  constexpr inline Key(std::int32_t val) : value(val) {}
  constexpr inline Key& operator=(std::int32_t val)
  {
    value = val;
    return *this;
  }

  explicit constexpr inline Key(std::size_t val) : value(static_cast<std::int32_t>(val)) {}
  constexpr inline Key& operator=(std::size_t val)
  {
    value = static_cast<std::int32_t>(val);
    return *this;
  }

  explicit constexpr inline Key(char32_t val) : value(static_cast<std::int32_t>(val)) {}
  constexpr inline Key& operator=(char32_t val)
  {
    value = static_cast<std::int32_t>(val);
    return *this;
  }

  constexpr inline operator std::int32_t() { return this->value; }
};
...
public:
  ...
  constexpr inline MetaKey()                              = default;
  constexpr inline MetaKey(const MetaKey& key)            = default;
  constexpr inline MetaKey& operator=(const MetaKey& key) = default;

  constexpr inline MetaKey(const Value& v) : value(static_cast<std::int32_t>(v)) {}
  constexpr inline MetaKey& operator=(const Value& v)
  {
    this->value = static_cast<std::int32_t>(v);
    return *this;
  }

  explicit constexpr inline MetaKey(std::int32_t val) : value(val) {}
  constexpr inline MetaKey& operator=(std::int32_t val)
  {
    value = val;
    return *this;
  }
...
constexpr inline bool operator==(Key l, Key r) { return l.value == r.value; }
constexpr inline bool operator==(MetaKey l, MetaKey r) { return l.value == r.value; }
constexpr inline bool operator==(MetaKey l, MetaKey::Value r) { return l == MetaKey(r); }
constexpr inline bool operator==(MetaKey::Value l, MetaKey r) { return MetaKey(l) == r; }
constexpr inline bool operator==(Key l, MetaKey r) { return l.value == r.value; }
constexpr inline bool operator==(MetaKey l, Key r) { return l.value == r.value; }
constexpr inline bool operator==(Key l, char r) { return l == Key(r); }
constexpr inline bool operator==(char l, Key r) { return Key(l) == r; }
constexpr inline bool operator==(Key l, char32_t r) { return l == Key(r); }
constexpr inline bool operator==(char32_t l, Key r) { return Key(l) == r; }
constexpr inline bool operator==(Key l, std::int32_t r) { return l == Key(r); }
constexpr inline bool operator==(std::int32_t l, Key r) { return Key(l) == r; }
constexpr inline bool operator==(Key l, std::size_t r) { return static_cast<std::size_t>(l.value) == r; }
constexpr inline bool operator==(std::size_t l, Key r) { return l == static_cast<std::size_t>(r.value); }
...
constexpr inline bool operator!=(Key l, Key r) { return !(l == r); }
constexpr inline bool operator!=(MetaKey l, MetaKey r) { return !(l == r); }
constexpr inline bool operator!=(MetaKey l, MetaKey::Value r) { return !(l == r); }
constexpr inline bool operator!=(MetaKey::Value l, MetaKey r) { return !(l == r); }
constexpr inline bool operator!=(Key l, MetaKey r) { return !(l == r); }
constexpr inline bool operator!=(MetaKey l, Key r) { return !(l == r); }
constexpr inline bool operator!=(Key l, char r) { return !(l == r); }
constexpr inline bool operator!=(char l, Key r) { return !(l == r); }
constexpr inline bool operator!=(Key l, char32_t r) { return !(l == r); }
constexpr inline bool operator!=(char32_t l, Key r) { return !(l == r); }
constexpr inline bool operator!=(Key l, std::int32_t r) { return !(l == r); }
constexpr inline bool operator!=(std::int32_t l, Key r) { return !(l == r); }
constexpr inline bool operator!=(Key l, std::size_t r) { return !(l == r); }
constexpr inline bool operator!=(std::size_t l, Key r) { return !(l == r); }
...
constexpr inline bool operator>(Key l, Key r) { return r < l; }
constexpr inline bool operator>(MetaKey l, MetaKey r) { return r < l; }
constexpr inline bool operator>(MetaKey l, MetaKey::Value r) { return r < l; }
constexpr inline bool operator>(MetaKey::Value l, MetaKey r) { return r < l; }
constexpr inline bool operator>(MetaKey l, Key r) { return r < l; }
constexpr inline bool operator>(Key l, MetaKey r) { return r < l; }
constexpr inline bool operator>(Key l, char r) { return r < l; }
constexpr inline bool operator>(char l, Key r) { return r < l; }
constexpr inline bool operator>(Key l, char32_t r) { return r < l; }
constexpr inline bool operator>(char32_t l, Key r) { return r < l; }
constexpr inline bool operator>(Key l, std::int32_t r) { return r < l; }
constexpr inline bool operator>(std::int32_t l, Key r) { return r < l; }
constexpr inline bool operator>(Key l, std::size_t r) { return r < l; }
constexpr inline bool operator>(std::size_t l, Key r) { return r < l; }
...
constexpr inline bool iscntrl(Key key) { return (key >= Key::Null && key <= Key::Ctrl_Underscore) || key == Key::Del; }
constexpr inline bool isblank(Key key) { return key == Key::Tab || key == Key::Space; }
constexpr inline bool isspace(Key key) { return isblank(key) || (key >= Key::Ctrl_J && key <= Key::Enter); }
constexpr inline bool isupper(Key key) { return key >= Key::A && key <= Key::Z; }
constexpr inline bool islower(Key key) { return key >= Key::a && key <= Key::z; }
constexpr inline bool isalpha(Key key) { return (isupper(key) || islower(key)); }
constexpr inline bool isdigit(Key key) { return key >= Key::Zero && key <= Key::Nine; }
constexpr inline bool isxdigit(Key key) { return isdigit(key) || (key >= Key::A && key <= Key::F) || (key >= Key::a && key <= Key::f); }
constexpr inline bool isalnum(Key key) { return (isdigit(key) || isalpha(key)); }
constexpr inline bool ispunct(Key key)
{
...
constexpr inline bool isgraph(Key key) { return (isalnum(key) || ispunct(key)); }
constexpr inline bool isprint(Key key) { return (isgraph(key) || key == Key::Space); }
constexpr inline bool isunicode(Key key) { return key >= Key::Null && key.value <= 0x10FFFFL; }
constexpr inline Key  tolower(Key key) { return (isalpha(key) && isupper(key)) ? Key(key.value + 32) : key; }
constexpr inline Key  toupper(Key key) { return (isalpha(key) && islower(key)) ? Key(key.value - 32) : key; }

// Detect if key is convertible to ANSII
constexpr inline bool isASCII(Key key) { return key >= Key::Null && key <= Key::Del; }

// Detect if key is convertible to Extended ANSII
constexpr inline bool isExtendedASCII(Key key) { return key >= Key::Null && key.value <= 255L; }

// Detect if key has CTRL+*
constexpr inline bool hasCtrlAll(Key key) { return iscntrl(key) || ((key.value & static_cast<std::int32_t>(MetaKey::Value::Ctrl)) == static_cast<std::int32_t>(MetaKey::Value::Ctrl)); }

// Detect if key has CTRL+* (excluding the CTRL+* that can be access with standard key Tab Backspace Enter...)
constexpr inline bool hasCtrl(Key key)
{
...
constexpr inline bool hasAlt(Key key) { return (key.value & static_cast<std::int32_t>(MetaKey::Value::Alt)) == static_cast<std::int32_t>(MetaKey::Value::Alt); }

constexpr inline bool empty(Key key) { return (key == Key::NoKey); }
...
constexpr inline bool hasAlt(MetaKey metakey) { return (metakey.value & static_cast<std::int32_t>(MetaKey::Value::Alt)) == static_cast<std::int32_t>(MetaKey::Value::Alt); }
constexpr inline bool hasCtrl(MetaKey metakey) { return (metakey.value & static_cast<std::int32_t>(MetaKey::Value::Ctrl)) == static_cast<std::int32_t>(MetaKey::Value::Ctrl); }

constexpr inline MetaKey operator+(MetaKey l, MetaKey r) { return MetaKey(l.value | r.value); }
constexpr inline Key     operator+(MetaKey metakey, Key key)
{
...
constexpr inline Key     operator+(Key key, MetaKey meta) { return meta + key; }
constexpr inline MetaKey operator+(MetaKey::Value l, MetaKey::Value r) { return MetaKey(l) + MetaKey(r); }
constexpr inline Key     operator+(MetaKey::Value l, Key r) { return MetaKey(l) + r; }
constexpr inline Key     operator+(Key l, MetaKey::Value r) { return l + MetaKey(r); }
constexpr inline Key     operator+(MetaKey::Value l, Key::value_type r) { return MetaKey(l) + Key(r); }
constexpr inline Key     operator+(Key::value_type l, MetaKey::Value r) { return Key(l) + MetaKey(r); }
