...
public:
  ...
  TERM_CONSTEXPR_FUNCTION inline Key& operator=(std::string_view str)
  {
    (void)Term::utf8_to_utf32(str.begin(), str.end(), &this->value);
    return *this;
  }
...
TERM_CONSTEXPR_FUNCTION inline Key     operator+(MetaKey metakey, Key key)
{
  ...
  else if(metakey == MetaKey::Value::None) { return key; }
